                    ...
                    <div className={styles.singleCard_profileContainer}>
                      ...
                      <div>
                        ...
                        <div className={styles.optionsContainer}>
                          ...
                          className={styles.singleOption_contsiner}>
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                          ...
                          onClick={() => {
                           ...
                           className={styles.singleOption_contsiner}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            className={styles.allCommentsContainer}>
              ...
              <div>
                {postState.comments.map((postComment) => {
                  ...
                  <div className={styles.singleComment} key={postComment._id}>
                    <div className="singleComment_porfile container">
                      <img width={20} src={`${BASE_URL}/uploads/${authState.user.userId.profilePicture}`} alt=''/>
              ...
              <div className={styles.postCommentContainer}> 
                ...
                <div onClick={async () => {
                  ...
                  className={styles.postCommentContainer_commentBin}
                 ><p>Comment</p></div>
              </div>
            </div>
        </div>
